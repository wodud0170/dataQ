...
![분류어/도메인 cascade 모달](manual_screenshots/16b_term_recommend_clsf_modal.png)

분류어 선택 후의 상태 (도메인 cascade 자동 로드):

![분류어 선택 후](manual_screenshots/16c_term_recommend_clsf_picked.png)
